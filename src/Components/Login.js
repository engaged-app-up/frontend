    ...
    return (
      <div className="relative flex flex-col justify-center min-h-screen overflow-hidden p-4 gap-3">
        <div className="w-full md:max-w-xs mx-auto">
          <img className="logo-fill" src={logo} />
        </div>
        <div className="w-full p-6 mx-auto bg-white rounded-md shadow-md lg:max-w-xl ">
          ...
          <form className="mt-6">
            ...
            <div className="mt-6">
              <button
                ...
                className="w-full px-4 py-2 tracking-wide text-white transition-colors duration-200 transform bg-sky-600 rounded-md hover:bg-sky-500 focus:outline-none focus:bg-purple-600"
              >
          ...
          <p className="mt-8 text-xs font-light text-center text-gray-700">
            ...
            <a
              href="#"
              className="ml-1 font-medium text-sky-400 hover:underline"
